...
class AuthService {
  ...
  final String keycloakUrl = 'http://localhost:8080';
  final String realm = 'ProgettoPSW';
  final String clientId = 'album-app';
  final String redirectUrl = 'http://localhost:8083/albums';
